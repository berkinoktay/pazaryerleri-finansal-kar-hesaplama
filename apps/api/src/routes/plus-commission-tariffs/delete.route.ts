...
import { deletePlusTariff } from '../../services/plus-commission-tariff.service';
import { PlusTariffIdPathSchema } from '../../validators/plus-commission-tariff.validator';

const app = createSubApp<{ Variables: { userId: string } }>();

const deletePlusTariffRoute = createRoute({
  method: 'delete',
...
app.openapi(deletePlusTariffRoute, async (c) => {
  ...
  await deletePlusTariff(orgId, storeId, tariffId);
