...
// (list / detail / config PATCH / selections / delete). The storeId in the path MUST
// belong to the caller's org, and a listId from another store must be indistinguishable
// from missing.
//
