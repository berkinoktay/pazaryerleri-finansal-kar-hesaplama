...
// INTERNATIONAL_SERVICE (mikro ihracat Uluslararası Hizmet Bedeli) + OVERSEAS_RETURN_OPERATION
// (mikro ihracat Yurt Dışı İade Operasyon Bedeli): deterministik ESTIMATE'ler — PaymentOrder
// cycle'ında confirm edilir ki settled kâra girsin (gerçek bedel otherfinancials'ta period-level gelir).
