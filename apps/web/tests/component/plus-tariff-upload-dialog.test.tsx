...
import { PlusTariffUploadDialog } from '@/features/campaigns/components/plus-tariff-upload-dialog';

import trMessages from '../../messages/tr.json';
import { render, screen } from '../helpers/render';

const UPLOAD = trMessages.plusCommissionTariffsPage.upload;
...
describe('<PlusTariffUploadDialog>', () => {
  ...
  it('shows the Plus-specific message for a duplicate-week rejection', () => {
    render(<Harness errorCode="DUPLICATE_TARIFF_WEEK" />);
    expect(screen.getByText(UPLOAD.errors.DUPLICATE_TARIFF_WEEK)).toBeInTheDocument();
  });
