...
function argsToFilters(args: ListProductsArgs): ProductListFilters {
  return {
    ...
    salePriceMin: args.salePriceMin,
    salePriceMax: args.salePriceMax,
    stockMin: args.stockMin,
    stockMax: args.stockMax,
    vatRateIn: args.vatRateIn,
    brandIdIn: args.brandIdIn,
    categoryIdIn: args.categoryIdIn,
    page: args.page,
