...
import type { AdvantageTariffSummary } from '../lib/advantage-tariff-summary';
...
export interface AdvantageTariffsSummaryProps {
  summary: AdvantageTariffSummary;
}

/**
 * Header KPI strip for an open Advantage tariff: products in the upload, how many the
 * seller has chosen a tier (or custom price) for, the estimated profit of those chosen
 * products, and the "do nothing" current-profit baseline. Mirrors the list's StatStrip
 ...
 */
export function AdvantageTariffsSummary({
  summary,
}: AdvantageTariffsSummaryProps): React.ReactElement {
  const t = useTranslations('productLabelsPage.summary');
