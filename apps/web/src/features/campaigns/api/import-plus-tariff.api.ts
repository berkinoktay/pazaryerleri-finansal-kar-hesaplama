...
export type ImportPlusTariffResponse = components['schemas']['ImportPlusTariffResponse'];

/**
 * POST /v1/organizations/{orgId}/stores/{storeId}/plus-commission-tariffs/import
 *
 * Uploads a Trendyol Plus commission-tariff `.xlsx` as `multipart/form-data`.
 *
...
export async function importPlusTariff(
  ...
  file: File,
  name?: string,
): Promise<ImportPlusTariffResponse> {
