...
const CATEGORIES: CategoryCard[] = [
  {
    ...
    count: 8,
    description:
      'Veri-okuma yüzeyleri: KPI tile, sayı/yüzde delta, currency, badge stack, enum-mapping badge, marketplace logosu, boş durum.',
    components:
      'KpiTile · StatGroup · TrendDelta · Currency · BadgeWithOverflow · MappedBadge · MarketplaceLogo · EmptyState',
  },
  {
  ...
  },
  {
    ...
    count: 8,
    description:
      "Veri güncelliği, çalışan iş takibi, hata bildirimleri, ContextRail uyarıları, app-spanning sistem mesajları, çok-adımlı akış göstergesi + kabuğu, kronolojik olay timeline'ı.",
    components:
      'SyncBadge · SyncCenter · NotificationBell · Banner · Stepper · Wizard · ActivityFeed · RailWarningCard',
  },
  {
  ...
  },
  {
    ...
    count: 3,
    description:
      'TanStack Table v8 wrapper + standart toolbar + seçili satırlar için bulk action bar. Filtreleme, sıralama, seçim, kolon görünürlüğü, import/export, boş durum, yükleme iskeleti.',
    components: 'DataTable · DataTableToolbar · BulkActionBar',
  },
];
