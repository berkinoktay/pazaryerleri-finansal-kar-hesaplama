...
Trendyol sisteminde oluşan muhasebesel kayıtlarınızı bu servis aracılığı ile entegrasyon üzerinden çekebilirsiniz. Finansal kayıtlar sipariş teslim edildikten sonra oluşmaktadır.

### Önemli Notlar

- **transactionType veya transactionTypes girilmesi zorunludur:** `transactionType` için 1 istekte yalnızca 1 type girilebilir. `transactionTypes` girilmesi halinde 1 istekte birden fazla type girilebilir. Örnek: `transactionTypes=Type1, Type2`. `transactionType` ve `transactionTypes` beraber girilmesi durumunda `transactionTypes` için girilen değerler geçerli kabul edilir.
- **paymentOrderId:** Siparişin ödemesi yapıldıktan sonra oluşmaktadır. İstisnalar hariç, her çarşamba, ilgili haftada vadesi gelen siparişler için ödeme emri oluşur. `paymentOrderId` ile sipariş ve ödemelerinizi eşleştirebilirsiniz.
...
- **Other Financial servisinden:** Tedarikçi finansmanı, virman, ödemeler (hakediş), faturalar (Trendyoldan tedarikçiye), tedarikçi faturaları (Tedarikçiden Trendyola), gelen havale, komisyon mutabakat faturaları işlemlerinin detaylarına ulaşabilirsiniz.

---

## GET settlements

**PROD:** https://apigw.trendyol.com/integration/finance/che/sellers/{sellerId}/settlements

**STAGE:** https://stageapigw.trendyol.com/integration/finance/che/sellers/{sellerId}/settlements
...
### Parametreler (settlements)

| Parametre                             | Parametre Değeri                                                                                                                                                                                                                                                                                       | Açıklama                                                                                             | Tip             | Zorunlu |
| :------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------- | :-------------- | :------ |
...
| size                                  | 500 ve 1000                                                                                                                                                                                                                                                                                            | Bir sayfada listelenecek maksimum adeti belirtir. (Default=500)                                      | int             | Hayır   |
| supplierId                            | -                                                                                                                                                                                                                                                                                                      | İlgili tedarikçinin ID bilgisi gönderilmelididir                                                     | long            | Evet    |
...
### Transaction Type Açıklamaları (settlements)

| Transaction Type            | Açıklama                                                                                                                                                                       |
| :-------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| SellerRevenuePositiveCancel | Hakediş Pozitif Düzeltme İptali                                                                                                                                                |
| SellerRevenueNegativeCancel | Hakediş Negatif Düzeltme İptali                                                                                                                                                |
| CommissionPositiveCancel    | Komisyon Pozitif Düzeltme İptali                                                                                                                                               |
| CommissionNegativeCancel    | Komisyon Negatif Düzeltme İptali                                                                                                                                               |

### Örnek Servis Cevabı (transactionType=Sale)
...
**PROD:** https://apigw.trendyol.com/integration/finance/che/sellers/{sellerId}/otherfinancials

**STAGE:** https://stageapigw.trendyol.com/integration/finance/che/sellers/{sellerId}/otherfinancials
...
### Transaction Type Açıklamaları (otherfinancials)
...
### Örnek Servis Cevabı (transactionType=PaymentOrder)
...
## Transaction Type Karşılaştırma Tablosu
...
| DiscountCancel              |  +  | İndirim İptali                        | Alacak (+) |
| Coupon                      |  +  | Kupon                                 | Alacak (+) |
| CouponCancel                |  +  | Kupon İptali                          | Borç (-)   |
| ProvisionPositive           |  -  | Provizyon +                           | Alacak (+) |
| ProvisionNegative           |  -  | Provizyon -                           | Borç (-)   |
...
| TYCouponCancel              |  +  | Kurumsal Fatura - TY Kupon İptali     | Alacak (+) |
| ManuelRefund                |  -  | Kısmi İade                            | Borç (-)   |
| ManuelRefundCancel          |  -  | Kısmi İade İptali                     | Alacak (+) |
...
| SellerRevenuePositiveCancel |  -  | Hakediş Pozitif Düzeltme İptali       | Borç (-)   |
| SellerRevenueNegativeCancel |  +  | Hakediş Negatif Düzeltme İptali       | Alacak (+) |
| CommissionPositiveCancel    |  +  | Komisyon Pozitif Düzeltme İptali      | Alacak (+) |
| CommissionNegativeCancel    |  -  | Komisyon Negatif Düzeltme İptali      | Borç (-)   |

---

## Parametre - commissionAmount - sellerRevenue Karşılaştırması

| Parametre                   | commissionAmount | sellerRevenue |
| :-------------------------- | :--------------: | :-----------: |
| Sale                        |        -         |       +       |
| Return                      |        +         |       -       |
| Discount                    |        +         |       -       |
