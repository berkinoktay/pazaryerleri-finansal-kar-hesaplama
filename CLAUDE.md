...
The three majors below are intentionally held back. Each has a reason — do not bump them on a whim, and do not let a fresh AI session reach for the latest just because it is "current." (pnpm 9→10 and TypeScript 5.9→6 were on this list; both migrated — see commit history.)
